...
namespace SelectionSystem
{
	...
	public class IndicatorSignalStickyPlane : MonoBehaviour {
		...
		*/
		...
		protected Ray ray;
		public float safeDepth = Mathf.Infinity;
		...
		protected bool firstTurn = false;
		void OnDrag ()
		{
			
			bool onPress = Input.GetButtonDown("mouse 1");
			...
			if (onPress && Physics.Raycast(ray, out hit, Mathf.Infinity, activeLayers))
	        {
