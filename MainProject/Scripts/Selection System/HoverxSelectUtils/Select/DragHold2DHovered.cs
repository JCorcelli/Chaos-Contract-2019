...
namespace SelectionSystem
{
	...
	public class DragHold2DHovered : SelectAbstract {
		...
		public bool screenBound = false;
		public bool interiorBound = true;
		...
		protected void SetDrag() {
			...
			currentPosition = heldThing.position;
			if (horizontal)
				currentPosition.x = lastMousePosition.x + hitOffset.x;
			if (vertical)
				currentPosition.y = lastMousePosition.y + hitOffset.y;
			
			
			heldThing.position = currentPosition ;
