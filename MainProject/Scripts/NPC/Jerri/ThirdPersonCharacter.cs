...
namespace NPCSystem
{
	...
	public class ThirdPersonCharacter : MonoBehaviour, IMovable
	{
		...
		public void OnAnimatorMove()
		{
			...
			if (Time.deltaTime > 0)
			{
				...
				m_Rigidbody.rotation *= m_Animator.deltaRotation; // I should probably make sure it points upwards on the ground normal here
			}
