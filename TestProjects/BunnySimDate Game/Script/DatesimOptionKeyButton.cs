...
namespace Datesim
{
	public class DatesimOptionKeyButton : AbstractButtonHandler, IBool, IMessage {
		...
		protected override void OnEnable( ){
			...
			if (gameObject.GetComponent<DatesimOptionRecolor>() == null)
				AddRecolorOb();
			
			if (gameObject.GetComponent<DatesimOptionSelect>() == null)
				AddSelectOb();
			
			if (gameObject.GetComponent<DatesimAppAddResponse>() == null)
				AddResponseOb();
			AddEffectOb();
		}
		...
		protected virtual void AddResponseOb() {
			DatesimAppAddResponse newOb = gameObject.AddComponent(typeof(DatesimAppAddResponse)) as DatesimAppAddResponse;
			newOb.message = message;
		}
		...
		protected virtual void AddRecolorOb() {
			DatesimOptionRecolor newOb = gameObject.AddComponent(typeof(DatesimOptionRecolor)) as DatesimOptionRecolor;
			newOb.message = message;
		}
