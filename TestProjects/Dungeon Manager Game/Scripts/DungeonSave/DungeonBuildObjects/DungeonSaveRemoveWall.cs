...
namespace Dungeon.Save
{
	...
	public class DungeonSaveRemoveWall : MonoBehaviour, IDungeonSaveStatic {
		// This goes in the spawned object
		
		
		public static string prefabPath = "DungeonBuildMode/RemoveWall";
		
		public static string prefabName = "RemoveWallS";
